...
open class WindowViewController: UIViewController
{
    ...
    convenience public init() {
        self.init(config: SnackBoard.Config())
    }

    public init(config: SnackBoard.Config) {
        self.config = config
    ...
    let config: SnackBoard.Config
}

extension WindowViewController {
    static func newInstance(config: SnackBoard.Config) -> WindowViewController {
