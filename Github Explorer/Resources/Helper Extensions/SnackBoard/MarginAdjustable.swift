...
/*
 ...
 `layoutMargins` adjusted by SnackBoard to account for the height of the
...
public protocol MarginAdjustable {
    ...
    /// When `true`, SnackBoard automatically collapses layout margin additions (topLayoutMarginAddition, etc.)
