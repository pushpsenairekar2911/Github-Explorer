...
extension UIViewController {
    ...
    func sm_selectPresentationContextTopDown(_ config: SnackBoard.Config) -> UIViewController {
    ...
    func sm_selectPresentationContextBottomUp(_ config: SnackBoard.Config) -> UIViewController {
        let topBottomStyle = config.presentationStyle.topBottomStyle
...
extension SnackBoard.PresentationStyle {
