...
class Presenter: NSObject {
    ...
    init(config: SnackBoard.Config, view: UIView, delegate: PresenterDelegate) {
        self.config = config
        self.view = view
    ...
    private static func animator(forPresentationStyle style: SnackBoard.PresentationStyle, delegate: AnimationDelegate) -> Animator {
        switch style {
        case .top:
    ...
    private func getPresentationContext() throws -> PresentationContext {
        ...
        case .automatic:
            #if SnackBoard_APP_EXTENSIONS
            throw SnackBoardError.noRootViewController
            #else
